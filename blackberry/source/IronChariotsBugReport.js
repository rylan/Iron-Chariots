...
enyo.kind({
	...
	openForumsPage: function() {
		...
		var args = new blackberry.invoke.BrowserArguments('http://forum.ironchariots.org');
	...
	sendEmail: function(){
		/*try {
			...
			{*/
				var args = new blackberry.invoke.MessageArguments('dev@icottrell.com', 'Iron Chariots Bug Report', 'This page '+this.pagelink +' was found to have rendering issues. Please report the device you were using and any additional information.');
