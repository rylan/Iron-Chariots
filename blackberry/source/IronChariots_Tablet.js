...
enyo.kind({
	...
	components:[
		...
		{kind: "PageHeader", onclick: "openAbout", components:[
		...
		{flex: 1, kind: "SlidingPane", name: "pane", components: [
			...
			{kind:"SlidingView", dragAnywhere: false, name:"middle", flex:5, components:[
				...
				{kind: "Toolbar", components:[
					...
					{icon:"img/wiki.png", onclick:"openSitePage", showing:false},
	...
	openwiki: function() {
		...
		var args = new blackberry.invoke.BrowserArguments('http://wiki.ironchariots.org');
