	...
	components: [
		{kind: "HFlexBox", components:[
			...
			{kind:"VFlexBox", flex:1, components:[
				...
				{content: "Version 0.2.0", className: "aboutver"},
				{content: "Developed by iCottrell.com", className:"abouttxt"},
				{content: "Direct all inquries to dev@icottrell.com", className:"abouttxt"},
				{content: "This is an open source project http://http://rylan.github.com/Iron-Chariots--WebOS/", onclick: "openProject", className:"abouttxt"},
				{kind:"Spacer"},
